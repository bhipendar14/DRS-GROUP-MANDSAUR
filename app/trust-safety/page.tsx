  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Our Security Certifications</h2>
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-700">
            <div className="p-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="flex flex-col items-center">
                  <div className="h-16 w-16 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center mb-4">
                    <span className="text-gray-600 dark:text-gray-300 text-sm font-medium">ISO</span>
                  </div>
                  <span className="text-gray-900 dark:text-white font-medium text-center">ISO 27001</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="h-16 w-16 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center mb-4">
                    <span className="text-gray-600 dark:text-gray-300 text-sm font-medium">PCI</span>
                  </div>
                  <span className="text-gray-900 dark:text-white font-medium text-center">PCI DSS</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="h-16 w-16 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center mb-4">
                    <span className="text-gray-600 dark:text-gray-300 text-sm font-medium">GDPR</span>
                  </div>
                  <span className="text-gray-900 dark:text-white font-medium text-center">GDPR Compliant</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="h-16 w-16 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center mb-4">
                    <span className="text-gray-600 dark:text-gray-300 text-sm font-medium">SOC</span>
                  </div>
                  <span className="text-gray-900 dark:text-white font-medium text-center">SOC 2 Type II</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-8">
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
                <div>
                  ...
                  <p className="text-indigo-600 dark:text-indigo-400">security@indianstockmarket.com</p>
                </div>
                <div>
                  <div className="text-lg font-medium text-gray-900 dark:text-white">
                    Emergency Hotline
                  </div>
                  <p className="text-indigo-600 dark:text-indigo-400">+91 800-555-0199</p>
                </div>
              </div>
            </div>
          </div>
