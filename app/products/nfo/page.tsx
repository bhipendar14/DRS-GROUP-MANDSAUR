          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="hidden md:block relative">
              ...
              <div className={`relative rounded-lg overflow-hidden ${
                ...
                <Image
                  src="/assets/nfo-illustration.png"
                  width={540}
                  height={400}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[{
              ...
              name: "Aditya Birla Green Energy Fund",
              category: "Thematic - ESG",
              status: "Coming Soon",
              statusColor: "blue",
              minInvest: "₹1,000",
              dates: "June 12 - June 26, 2023",
              fundManager: "Vikram Patel",
              riskLevel: "High"
            }].map((nfo, index) => (
              <div key={index} className={`rounded-xl overflow-hidden ${
                ...
                <div className={`p-4 ${
                  theme === 'light' 
                    ? nfo.statusColor === 'green' ? 'bg-teal-50' 
                    : nfo.statusColor === 'blue' ? 'bg-blue-50' 
                    : 'bg-gray-50'
                    : nfo.statusColor === 'green' ? 'bg-teal-900/20' 
                    : nfo.statusColor === 'blue' ? 'bg-blue-900/20' 
                    : 'bg-gray-700'
                }`}>
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`text-xs px-2 py-1 rounded ${
                      theme === 'light' 
                        ? nfo.statusColor === 'green' ? 'bg-green-100 text-green-800' 
                        : nfo.statusColor === 'blue' ? 'bg-blue-100 text-blue-800' 
                        : 'bg-gray-100 text-gray-800'
                        : nfo.statusColor === 'green' ? 'bg-green-900 text-green-300' 
                        : nfo.statusColor === 'blue' ? 'bg-blue-900 text-blue-300' 
                ...
                <div className="p-6">
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{nfo.minInvest}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">NFO Period:</span>
                      <span className="font-medium">{nfo.dates}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Fund Manager:</span>
                      <span className="font-medium">{nfo.fundManager}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Risk Level:</span>
                      <span className={`font-medium ${
                        nfo.riskLevel === 'Very High' 
                          ? 'text-red-500' 
                          : nfo.riskLevel === 'High' 
                          ? 'text-orange-500' 
                          : 'text-yellow-500'
                  ...
                  <div className="mt-6">
                    <Link href={`/products/nfo/${nfo.name.toLowerCase().replace(/\s+/g, '-')}`} className={`w-full block text-center py-2 px-4 rounded-lg text-sm font-medium ${
                      nfo.status === "Open Now"
                        ? theme === 'light' ? 'bg-teal-600 text-white hover:bg-teal-700' : 'bg-teal-700 text-white hover:bg-teal-600'
                        : theme === 'light' ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-blue-700 text-white hover:bg-blue-600'
                    }`}>
                      {nfo.status === "Open Now" ? "Invest Now" : "Set Reminder"}
                    </Link>
                  </div>
                </div>
              </div>
      ...
      <section className={`py-20 px-4 ${
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/open-account" className="py-3 px-8 rounded-lg font-medium transition-all bg-white text-teal-700 hover:bg-gray-100">
              Open Investment Account
            </Link>
