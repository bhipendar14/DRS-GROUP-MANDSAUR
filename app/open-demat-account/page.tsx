...
import { CheckCircleIcon, DocumentTextIcon, IdentificationIcon, LockClosedIcon, ShieldCheckIcon } from '@heroicons/react/24/outline'
                ...
                {formSubmitted ? (
                  <div className="text-center py-10">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-md mx-auto">
                      We've received your information. Our team will contact you shortly to guide you through the next steps.
                    </p>
                    <button
                      type="button"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-center pt-6">
                      <button
                        type="submit"
                        className="px-12 py-3 bg-indigo-600 text-white font-medium rounded-md hover:bg-indigo-700 transition-all duration-200 text-center w-full sm:w-auto"
                      >
                        Submit Application
                      </button>
                    </div>
