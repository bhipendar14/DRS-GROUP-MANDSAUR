...
export default function IPOPage() {
  ...
  return (
    <div className={`min-h-screen ${theme === 'light' ? 'bg-white text-gray-800' : 'bg-gray-950 text-gray-200'}`}>
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link href="#current-ipos" className={`py-3 px-8 rounded-lg font-medium transition-all flex items-center justify-center ${
                theme === 'light' 
                ...
                View Current IPOs <ChevronRight size={18} className="ml-1" />
              </Link>
            </div>
          </div>
        </div>
      ...
      <section id="current-ipos" className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            {[
              {
                name: "TechInnovate Solutions Ltd",
                status: "Open Now",
                statusColor: "green",
                price: "₹1,350 - ₹1,425",
              ...
              <div key={index} className={`rounded-xl overflow-hidden ${
                ...
                <div className={`p-4 ${
                  theme === 'light' 
                    ? ipo.statusColor === 'green' ? 'bg-green-50' 
                    : ipo.statusColor === 'blue' ? 'bg-blue-50' 
                    : 'bg-gray-50'
                    : ipo.statusColor === 'green' ? 'bg-green-900/20' 
                    : ipo.statusColor === 'blue' ? 'bg-blue-900/20' 
                    : 'bg-gray-700'
                }`}>
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`text-xs px-2 py-1 rounded ${
                      theme === 'light' 
                        ? ipo.statusColor === 'green' ? 'bg-green-100 text-green-800' 
                        : ipo.statusColor === 'blue' ? 'bg-blue-100 text-blue-800' 
                        : 'bg-gray-100 text-gray-800'
                        : ipo.statusColor === 'green' ? 'bg-green-900 text-green-300' 
                        : ipo.statusColor === 'blue' ? 'bg-blue-900 text-blue-300' 
                ...
                <div className="p-6">
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-sm">Price Band:</span>
                      <span className="font-medium">{ipo.price}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Issue Dates:</span>
                      <span className="font-medium">{ipo.dates}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{ipo.minInvest}</span>
                    </div>
                  </div>
                  <div className="mt-6">
                    <Link href={`/products/ipo/${ipo.name.toLowerCase().replace(/\s+/g, '-')}`} className={`w-full block text-center py-2 px-4 rounded-lg text-sm font-medium ${
                      ipo.status === "Closed" 
                        ? theme === 'light' ? 'bg-gray-100 text-gray-500 cursor-not-allowed' : 'bg-gray-700 text-gray-400 cursor-not-allowed'
                        : theme === 'light' ? 'bg-purple-600 text-white hover:bg-purple-700' : 'bg-purple-700 text-white hover:bg-purple-600'
                    }`}>
                      {ipo.status === "Closed" ? "View Details" : "Apply Now"}
                    </Link>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className={`hidden md:block ${
                  ...
                  <div className="h-full flex items-center justify-center p-10">
                    <Image 
                      src="/assets/ipo-illustration.png" 
                      width={300} 
                      height={300} 
