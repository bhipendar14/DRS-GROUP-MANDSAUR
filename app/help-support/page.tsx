...
export default function HelpSupportPage() {
  ...
  const handleContactSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        // For testing, log the data that would be sent to dsrgroupmandsaur@gmail.com
        console.log('Sending support request to dsrgroupmandsaur@gmail.com:', contactForm)
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-1 space-y-6">
                  ...
                  <div className="flex items-start">
                    <MapPin className={`mt-1 mr-3 ${theme === 'light' ? 'text-purple-600' : 'text-purple-400'}`} />
                    <div>
                      <h3 className="font-medium">Address</h3>
                      <p className="mt-1">Kothari Colony, Patel Nagar, Kityani, Mandsaur, Madhya Pradesh 458001</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <Phone className={`mt-1 mr-3 ${theme === 'light' ? 'text-purple-600' : 'text-purple-400'}`} />
                    <div>
                      <h3 className="font-medium">Phone</h3>
                      <p className="mt-1">Mobile: +91-9024138649</p>
                      <p className="mt-1">Landline: 07422 - 496399</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <Mail className={`mt-1 mr-3 ${theme === 'light' ? 'text-purple-600' : 'text-purple-400'}`} />
                    <div>
                      <h3 className="font-medium">Email</h3>
                      <p className="mt-1">dsrgroupmandsaur@gmail.com</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <p className="mb-4">
                    Kothari Colony, Patel Nagar, Kityani, Mandsaur, Madhya Pradesh 458001
                  </p>
